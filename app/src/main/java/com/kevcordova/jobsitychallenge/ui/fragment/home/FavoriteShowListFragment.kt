...
class FavoriteShowListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(layoutInflater, R.layout.fragment_favorite_show_list, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = getString(R.string.my_favorite_show)
    }
}